...
if __name__ == '__main':
    ...
    print('From node ', sourcenode, ' to destination node ', destinationnode, ' length is ', length[destinationnode])
    print('From node ', sourcenode, ' to destination node ', destinationnode, ' path is ', path[4])